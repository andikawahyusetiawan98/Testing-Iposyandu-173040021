...
Mobile.takeScreenshot('F:\\Demo Testing Iposyandu\\TC-37.png', FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('Repo-Iposyandu-173040021/RKF-04-Mengelola Data Ibu Hamil/android.widget.Toast - Baby data created successfully'), 
    30, FailureHandling.OPTIONAL)

Mobile.takeScreenshot('F:\\Demo Testing Iposyandu\\TC-37.1.png', FailureHandling.STOP_ON_FAILURE)
