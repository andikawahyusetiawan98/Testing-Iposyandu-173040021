...
Mobile.waitForElementPresent(findTestObject('Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.TextView - PENDAFTARAN GAGAL Nomor telepon sudah digunakan oleh pengguna lain'), 
    30, FailureHandling.OPTIONAL)

Mobile.verifyElementVisible(findTestObject('Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.TextView - PENDAFTARAN GAGAL Nomor telepon sudah digunakan oleh pengguna lain'), 
    30, FailureHandling.OPTIONAL)

Mobile.takeScreenshot('F:\\Demo Testing Iposyandu\\TC-03.png', FailureHandling.STOP_ON_FAILURE)
