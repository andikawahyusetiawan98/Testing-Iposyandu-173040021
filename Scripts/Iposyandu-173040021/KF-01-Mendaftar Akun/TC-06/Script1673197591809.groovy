...
Mobile.tap(findTestObject('Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.FrameLayout lainnya'), 30)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.swipe(288, 1341, 0, 850)

Mobile.tap(findTestObject('Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.TextView - LOGOUT'), 30)
...
Mobile.setText(findTestObject('Object Repository/Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.EditText - PASSWORD (1)'), 
    '173040021', 30)

Mobile.setText(findTestObject('Object Repository/Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.EditText - ULANGI PASSWORD'), 
    'andika saja', 30)

Mobile.tap(findTestObject('Object Repository/Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.Button - KIRIM PENDAFTARAN (1)'), 
    30)

Mobile.tap(findTestObject('Object Repository/Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.EditText - andika saja'), 
    30)

Mobile.takeScreenshot('F:\\Demo Testing Iposyandu\\TC-06.png', FailureHandling.STOP_ON_FAILURE)

Mobile.delay(2, FailureHandling.STOP_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.EditText - andika saja'), 
    30, FailureHandling.OPTIONAL)

Mobile.tap(findTestObject('Object Repository/Repo-Iposyandu-173040021/RKF-01-Mendaftar Akun/android.widget.ImageButton'), 
    30)
